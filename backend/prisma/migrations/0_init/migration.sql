...
CREATE TABLE `items` (
    ...
    `category` ENUM('Books', 'Electronics', 'Clothing', 'Furniture', 'Stationery', 'Other') NOT NULL,
...
CREATE TABLE `audit_logs` (
    ...
    `target_type` ENUM('user', 'item', 'college', 'city', 'area', 'report', 'setting', 'category') NOT NULL,
